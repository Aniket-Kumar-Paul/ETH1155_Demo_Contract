...
contract Web3Builders is ERC1155, Ownable, Pausable, ERC1155Supply, PaymentSplitter {
    ...
    constructor(
        ...
        PaymentSplitter(_payees, _shares) // split the payment according to shares percentage
    {}
    ...
    // publicMint - can be minted by anyone
    ...
    // allowListMint - give special/cheap prices for hardcore fans/vip members etc
    ...
    function mint(uint256 id, uint256 amount) internal 
    {
        ...
        require(totalSupply(id) + amount <= maxSupply, "Not enough supply!");
    ...
    // Setting up ipfs uri for each nft   
